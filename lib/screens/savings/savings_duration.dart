...
class SavingsDurationScreen extends StatefulWidget {
  @override
  _SavingsDurationScreen createState() => _SavingsDurationScreen();
}

class _SavingsDurationScreen extends State<SavingsDurationScreen> {
  String? frequency;
  @override
                  ...
                  Container(
                      child: Column(
                        ...
                        Row(
                          children: [
                            IconInputField(
                              title: "When do you want to start saving?",
                    ...
                    children: [
                      Container(
                        child: IconInputField(
                          title: "Relationships with buddies",
                          placeholder: "08/12/2022",
                        ),
                      ),
                      h20Spacing,
